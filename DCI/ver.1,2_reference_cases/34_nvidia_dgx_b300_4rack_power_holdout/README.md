# Case 34 — NVIDIA DGX B300 high-density rack power hold-out
...
|---|---:|---:|---:|
| typical_it_power_kw | 58 | 58 | 0.0000% |
| design_max_power_kw | 60 | 60 | 0.0000% |
| peak_provisioning_power_kw | 76 | 78.8 | 3.6842% |

**MAPE: 1.2281% · Max error: 3.6842% · PASS.**
